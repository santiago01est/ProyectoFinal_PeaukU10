...
import { TextParagraphNormal, TextSubtitleCard, TextTitleCard } from "./texts";
...
const CardBlogContainerSC = styled.div`
  padding: 0;
  border-radius: 0.5rem;
  border: 2px solid rgba(102, 102, 102, 0.08);
  background: #fff;
...
const CardThingsYouNeedToDo = ({ title, subtitle, imgPath, linePath }) => {
  return (
    <div className="card p-2 mt-5">
      <img src={linePath} alt="line_signUp" className="line" />
  ...
  return (
    <CardPlanContainerSC className="card-travel p-0 book-card mt-5">
      ...
      >
        ...
        <button type="button" class="btn-fill btn btn-overlay">
          Book Now
        </button>
      </div>
      <div class="card-body p-2 mt-3">
        <div class="row">
          <div class="col d-flex d-flex justify-content-between align-items-center px-3">
            ...
            <TextSubtitleCard style={{ display: "flex", alignItems: "center" }}>
              {" "}
              <img
                style={{ width: "1.4rem", marginRight: "10px" }}
                src="../icons/star.svg"
              />
              {score}
            </TextSubtitleCard>
        ...
        <div class="row mt-3 px-3">
          ...
          <div class="col px-0 d-flex justify-content-end align-items-center">
            ...
            <div class="col-6 ms-2 px-0 text-center ">
              <p id="precio-actual" class="card-text tag-div">
                $ {price}
              </p>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col d-flex d-flex justify-content-between px-3">
            ...
            <div className="col-3 ms-2 px-0 text-center  justify-content-end">
              <TextTitleCard style={{ color: Colors.secondary }}>
                $ {price}
              </TextTitleCard>
            </div>
          </div>
  ...
  return (
    <CardCommentContainerSC>
      ...
      <article className="card-people-about author mt-3">
        <p style={{ lineHeight: "2rem" }}>{comment}</p>
        <div className="d-flex flex-column">
          <h6
            style={{ fontSize: "18px", fontWeight: "600", lineHeight: "2rem" }}
          >
            {name}
          </h6>
...
const CardBlog = ({ imgPath, title, date }) => {
    return (
    <CardBlogContainerSC>
      ...
      <div class="card-body mt-3">
        <div class="row">
          <div class="col px-4">
          <TextParagraphNormal>{title}</TextParagraphNormal>
          </div>
        </div>
        <div class="row mt-3">
          <div class="col px-4">
...
export { CardThingsYouNeedToDo, CardPlan, CardTravel, CardComments, CardBlog };
